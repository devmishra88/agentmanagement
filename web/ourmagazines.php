...
$condition		= " AND id=:id";
$CategoryEsql	= array("id"=>606,"status"=>1);
...
{
	?>
	<section class="page-section portfolio" id="ourmagazines">
		<div class="container">
			<h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">OUR MAGAZINES</h2>
			<!-- Icon Divider-->
