		...
		//$FullAddress	.= "<br>".$CityName.' / '.$StateName.' / '.$PinCode;
			...
			<div class="OrderWrapper" style="width:100%;<?if($_GET['bulkprinting'] == '1'){?>page-break-after: always;"<?}?>><!--  min-height:1440px; -->
				<div style="width:98%;" align="center">
					<table border='0' cellpadding='0' cellspacing='5' width='100%' align='center' valign='top' style="border:1px dashed #000000;">
						<tr>
							<td valign='top' align='center'>
								<div style="font-family:<?=$fontfamily;?>; color:#000;">
									<div style="font-size:<?php echo 24*$fonttobeincrease;?>px;font-weight:bold;"><?php echo $AgentName?></div>
					...
					<div style="border:1px solid #000; margin-top:5px;border-bottom:none;">
					...
					<table border='0' cellpadding='5' cellspacing='0' width='100%' style='border-collapse:collapse;' align='center'>
						<tr style='font-size:<?php echo 17*$fonttobeincrease;?>px; color: #000;line-height:<?php echo 18*$fonttobeincrease;?>px; vertical-align: middle; background-color:#fff; -webkit-print-color-adjust:exact;font-weight:bold;'>
						...
						<?php
						$OrderDetSQL		= "SELECT * FROM ".$Prefix."invoice_details WHERE invoiceid=:invoiceid ORDER BY inventoryname ASC,item_start_date ASC ";
						...
						if($Num > 0)
						{
							...
							while($ordrow = pdo_fetch_assoc($OrderDetailQuery))
							{
								...
								$ItemNaration	= "( ".date("d-M-Y",$InvStartDate)." - ".date("d-M-Y",$InvEndDate)." )";
					...
					<table border='0' cellpadding='2' cellspacing='2' width='100%'>
						<tr>
							<td valign='bottom' align='left'>
                                ...
                                <br/>
                                <div style="background-color:#fff; padding:3px; color:#000; -webkit-print-color-adjust:exact;width:50%;font-weight:bold;">
